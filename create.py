...
redbutton = Button(win,text="Top" , fg='Black' ,bg= 'red')
redbutton.pack(side= TOP)
greenbutton = Button(win,text="Right" , fg='Black' ,bg= 'green')
greenbutton.pack(side= RIGHT)
bluebutton = Button(win,text="Left" , fg='Black' ,bg= 'blue')
bluebutton.pack(side= LEFT)
yellowbutton = Button(win,text="Bottom" , fg='Black' ,bg= 'yellow')
yellowbutton.pack(side= BOTTOM) 

name = Label(win,text= 'Name').grid(row=0,column=0)
e1 = Entry(win).grid(row=0,column=1)
name = Label(win,text= 'Caste').grid(row=3,column=0)
e2 = Entry(win).grid(row=3,column=1)
win.mainloop()  """
